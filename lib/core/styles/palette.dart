...
/*
  Constant palette selection for the entire mobile app

  Add more static values if you want:

  Primary Background - primary color
  Secondary Background - secondary color
  Card Background -  primary card color
  Field Background - primary textfield color
  Accent Color - accent color for primary theme
*/
