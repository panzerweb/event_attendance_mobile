...
class _HistoryTileState extends State<HistoryTile> {
  // DELETE AN EVENT
  Future<void> _deletedCompletedEvent(EventEntity event) async {
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.event.priority_id) {
      case 1:
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  onPressed: () {
                    context.read<EventCubit>().toggleEventCubit(widget.event);
                  },
                  icon: widget.event.is_complete!
                      ? const Icon(Icons.check_box_rounded)
                      : const Icon(Icons.check_box_outline_blank_rounded),
                  style: IconButton.styleFrom(
                    backgroundColor: widget.event.is_complete!
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      /// Date Range
                      Text(
                        "${formatDates(widget.event.start_date)} - ${formatDates(widget.event.end_date)}",
                        style: TextStyle(
                ...
                IconButton(
                  onPressed: () async {
                    await _deletedCompletedEvent(widget.event);
                  },
